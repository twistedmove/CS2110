...
public class GUI extends JFrame implements ChangeListener {
    ...
    /**  Initialize the non component specific GUI attributes on panel panel
     * using random number seed seed. */
    private void initGUI(JPanel panel, long seed) {
        panel.setBackground(Common.MARGIN_COLOR);
        panel.setBorder(BorderFactory.createLineBorder(Common.MARGIN_COLOR, thickness));
    ...
    /** Initialize the menu at the top of the GUI's frame. The menu contains 
    ...
    /** Construct a menu item with various features.
     * 
    ...
    /** Constructor: a menu item with various features.
     * 
    ...
    private void initNorth(JPanel panel) {
        ...
        northPanel.setBackground(Common.BACKGROUND_COLOR);
...
*/
    ...
    /** Triggered by moving the fpm slider. Ensure that the butterfly, the
    ...
    /** Inform the simulator that the move is complete. 
     * 
