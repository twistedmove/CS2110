...
public class Game {
    ...
    /* When testing, you may want to comment out all the above statements
        ...
        public static void testGetPossibleMoves(){
             ...
             System.out.println("Error in getPossibleMoves with 1 col filled. array size is wrong: " +  moves2.length);
             }
        ...
        public static void testInitializeChildren(State y){
        	for (State x : y.getChildren()){
