...
public class GUITileInfo extends JPanel{
	...
	/** Add an info label label at (gridx, gridy) of constraints to the JPanel.*/
	...
	/* * Update the tile info box using tile. */
	...
	/** Return a nicely formatted label to display tile information. */
