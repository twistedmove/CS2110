...
public enum Direction {
    ...
    /** Return the Direction corresponding to direction d.
     * Throw a DirectionFormatException if d is not one of
     * "n", "ne", "e", "se", "s", "sw", "w", "nw" (upper or lower case).
     * 
     * @param d String representation of a direction. e.g. "N"
    ...
    public static Direction parseDirection(String d) {
        Debugger.NULL_CHECK(d, "null direction in parseDirection!");
