...
public abstract class Tile implements Comparable<Tile> {
	...
	static String OBSTACLES_DIR = "res/obstacles/";
	
	/** Image extension. */
	static String IMAGE_EXT = ".png";
	...
	/** Copy tile from to tile to. This method is designed to allow subclasses
	...
	/** Return a string representation of the object that can be used to print
	...
	/** Return a tile's unique printable character. Each tile has a unique
